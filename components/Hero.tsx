      ...
      <div className="w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-1 lg:max-w-[50%] pt-8">
            ...
            <Link to="/book" className="group flex w-fit items-center gap-3 bg-white text-dark pl-6 pr-2 py-2 rounded-full border border-gray-200 hover:shadow-2xl hover:shadow-primary/40 transition-all duration-500 shadow-xl shadow-primary/10 relative overflow-hidden">
